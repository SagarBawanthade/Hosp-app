  ...
  return (
    <div className="container">
      <div className="w-75 mx-auto shadow p-5">
        <h2 style={{ color: "#005dff", textAlign: "center", fontSize: "40px" }} className="text-center mb-4">Add New Record</h2>
        <form onSubmit={e => onSubmit(e)}>
          <div className="form-group">
            ...
            <input
              ...
              onChange={e => onInputChange(e)}
            />
            <label className="form-group" htmlFor="dateofadd">Date of Addmission</label>
            <input
              id="dateofadd"
              type="date"
              className="form-control form-control-lg"
